  ...
  const defaultRenderWalletItem = (wallet: WalletOption) => (
    <div
      ...
      className={cn(
        ...
        hoverWallet === wallet.id && "bg-gradient-to-r from-blue/5 to-lime/5 border-blue/30"
      )}
    ...
    <div className="p-6 flex flex-col h-full bg-gradient-to-br from-blue/5 via-transparent to-lime/5 dark:from-blue/10 dark:via-transparent dark:to-lime/10">
      <div className="mb-4 flex items-center">
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue/20 dark:bg-blue/30 mr-3">
          <svg className="h-5 w-5 text-blue dark:text-lime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <h3 className="text-lg font-semibold text-blue dark:text-lime">What is a Wallet?</h3>
      </div>
      <div className="flex-grow relative">
        ...
        <div className="mt-4 rounded-lg border border-blue/20 dark:border-lime/20 p-3 bg-white/50 dark:bg-gray-800/50 shadow-sm">
          <h4 className="text-xs font-medium text-blue dark:text-lime mb-2">Benefits:</h4>
      ...
      <div className="mt-auto pt-4 border-t border-blue/10 dark:border-lime/10">
        <div className="flex items-center justify-center">
          <span className="text-xs text-blue/60 dark:text-lime/60 mr-2">Powered by</span>
          <span className="text-xs font-bold bg-gradient-to-r from-blue to-lime bg-clip-text text-transparent">SUI Network</span>
        </div>
      </div>
    </div>
  );
              ...
              <div className={cn(
                ...
                <div className="p-6 flex-grow overflow-y-auto">
                  <div className="mb-4 flex items-center">
                    ...
                    <p className="text-sm text-blue dark:text-lime font-medium">Choose your wallet</p>
                ...
                <div className={cn(
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                    By connecting, you agree to the <span className="text-blue dark:text-lime">Terms & Privacy Policy</span>.
                  </p>
                </div>
              </div>
