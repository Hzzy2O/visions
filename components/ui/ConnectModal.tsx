...
const contractConfig = networkConfig[network].variables;
const USER_MODULE_PACKAGE_ID = contractConfig.package;
const USER_REGISTRY_ID = contractConfig.user_registry;
const USER_MODULE_NAME = "user";

export const ConnectWalletModal = forwardRef<ConnectWalletModalRef, ConnectWalletModalProps>(
  (
    {
      isOpen,
      onClose,
